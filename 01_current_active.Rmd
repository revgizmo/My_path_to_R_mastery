...
## Here’s my intro to R recommendation:

0. Read through 1,3, and 4 before starting

1. [New to R? Kickstart your learning and career with these 6 steps! – paulvanderlaken.com](https://paulvanderlaken.com/2017/10/18/learn-r/amp/)

2. (Step 5 from above) [R for Data Science](https://r4ds.had.co.nz/) (tidyverse)

3. Read this: [Happy Git and GitHub for the useR](https://happygitwithr.com/)

4: Read this: [Project-oriented workflow - Tidyverse](https://www.tidyverse.org/articles/2017/12/workflow-vs-script/)
